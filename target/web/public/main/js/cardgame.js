...
function addPlayer1Notification(message) {
	if (player1Notification==null) {
		...
		player1NotificationText.position.x = 450;
...
function addPlayer2Notification(message) {
	if (player2Notification==null) {
    	...
    	player2Notification.setPosition(1150, 100);
    	player2Notification.width = 500;
		...
		player2NotificationText.position.x = 1200;
